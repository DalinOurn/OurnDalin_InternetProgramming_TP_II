...
const create = async(params, req, res) => {
    ...
    try {
        ...
        return res.status(200).json({ status: "true", message: "Item created successfull!", data: addItem });
...
const deleteItem = async(params, req, res) => {
    ...
    try {
        ...
        return res.status(200).json({ status: "true", message: "Items deleted successfull!" });
    } catch (error) {
        return res.status(400).json({ status: "false", message: error });
    }
}
